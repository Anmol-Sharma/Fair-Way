...
t21 = Test(
    ...
    test_instruction="Check if metadata below has 'creator' and 'title' information. Check carefully as similar words could have been used for both.",
...
t22 = Test(
    ...
    test_instruction="Check if metadata below has 'publisher' and 'publication_date' information. Check carefully as similar words could have been used for both.",
...
t23 = Test(
    ...
    test_instruction="Check if metadata below has 'summary' and 'keywords' information. Check carefully as similar words could have been used for both.",
