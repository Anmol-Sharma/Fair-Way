...
FEW_SHOT_SAMPLES = [
    {
        ...
        "feedback": """{"file_list":[{"size":"2.5MB", "file_name":"environmental_data_2024_v1.1.csv", "d_type":"csv"}, {"size":"180KB", "file_name":"environmental_data_2024_v1.2.json", "d_type":"json"}]}""",
    },
    {
