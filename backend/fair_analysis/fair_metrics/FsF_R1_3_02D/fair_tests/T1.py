...
t1 = Test(
    ...
    test_main_cmd="""Your task is to help analyze the provided metadata and check if data file listed used open data file formats. An open file format is format which can be used by anyone royalty free. Key Tasks :-
    ...
    3. If any format is not open, return success as false.
